#ifndef VOXEL_GRID_COVARIANCE_OMP_H
#define VOXEL_GRID_COVARIANCE_OMP_H

#define USE_EXPLICIT_INSTANTIATION_VGC
...
#ifndef USE_EXPLICIT_INSTANTIATION_VGC
#include "voxel_grid_covariance_omp_impl.hpp"
#endif

#endif // VOXEL_GRID_COVARIANCE_OMP_H
