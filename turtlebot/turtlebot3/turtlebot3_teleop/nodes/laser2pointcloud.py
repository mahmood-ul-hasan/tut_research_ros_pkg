...
def imu_Listener(): 
    rospy.Subscriber("/imu", Imu, imu_ListenerCallback)
...
class Laser2PC():
    def __init__(self):
        ...
        self.laserSub = rospy.Subscriber("/scan", LaserScan, self.laserCallback) #topicName may be different, please modify it according to the actual situation. You can enter rostopic list in the terminal to view
