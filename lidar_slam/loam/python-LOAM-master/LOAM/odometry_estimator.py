    ...
    def find_edge_correspondences(self, sharp_points):
        ...
        for i in range(corners_cnt):
            ...
            if dist[0] < self.DISTANCE_SQ_THRESHOLD:
                print("if dist[0] < self.DISTANCE_SQ_THRESHOLD:", dist[0] < self.DISTANCE_SQ_THRESHOLD)
                ...
                print("if min_point_ind_2 >= 0: ", min_point_ind_2 )
                if min_point_ind_2 >= 0:
                    print("if min_point_ind_2 >= 0: ", min_point_ind_2 >= 0)
