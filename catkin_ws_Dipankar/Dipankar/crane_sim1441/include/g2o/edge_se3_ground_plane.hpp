#ifndef KKL_G2O_EDGE_SE3_GROUND_PLANE_HPP
#define KKL_G2O_EDGE_SE3_GROUND_PLANE_HPP
...
namespace g2o {
	class EdgeSE3GroundPlane : public g2o::BaseBinaryEdge<3, Eigen::Vector4d/*g2o::Plane3D*/, g2o::VertexSE3, g2o::VertexPlane> {
	public:
		...
		void computeError() override {
			...
			Eigen::Isometry3d w2n = v1->estimate();
                        ...
                        rss_err = ground_plane_rss_error_vertexi(w2n,v1->id());
			
			//Plane3D local_plane = w2n * v2->estimate();
			_error = Eigen::Vector3d(rss_err,0,0);//local_plane.ominus(_measurement);
