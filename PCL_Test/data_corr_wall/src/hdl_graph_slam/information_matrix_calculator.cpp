...
InformationMatrixCalculator::InformationMatrixCalculator(){ //ros::NodeHandle& nh) {
  ...
  const_stddev_x = 0.8; //nh.param<double>("const_stddev_x", 0.5);
  const_stddev_y = 0.008; 
  const_stddev_q = 0.001; //nh.param<double>("const_stddev_q", 0.1);
