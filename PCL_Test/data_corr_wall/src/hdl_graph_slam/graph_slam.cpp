...
namespace g2o {
  ...
  G2O_REGISTER_TYPE(EDGE_SE3_WALL_PLANE, EdgeSE3WallPlane)
...
g2o::EdgeSE3WallPlane* GraphSLAM::add_se3_wall_plane_edge(g2o::VertexSE3* v_se3, g2o::VertexPlane* v_plane, const Eigen::Vector4d rms_error, const Eigen::MatrixXd& information_matrix) {
  g2o::EdgeSE3WallPlane* edge(new g2o::EdgeSE3WallPlane());
  edge->setMeasurement(rms_error);
  edge->setInformation(information_matrix);
  edge->vertices()[0] = v_se3;
  edge->vertices()[1] = v_plane;
