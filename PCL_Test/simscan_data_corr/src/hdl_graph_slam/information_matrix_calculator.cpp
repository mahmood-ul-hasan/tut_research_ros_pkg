...
InformationMatrixCalculator::InformationMatrixCalculator(){ //ros::NodeHandle& nh) {
  ...
  const_stddev_xy = 0.008; //nh.param<double>("const_stddev_x", 0.5);
  const_stddev_z = 0.07; 
  const_stddev_q1 = 0.003; //nh.param<double>("const_stddev_q", 0.1);
  const_stddev_q2 = 0.002;
  const_stddev_q3 = 0.001;
