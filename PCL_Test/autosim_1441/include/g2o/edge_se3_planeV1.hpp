...
namespace g2o {
	class EdgeSE3Plane : public g2o::BaseBinaryEdge<3, Eigen::Vector3d, g2o::VertexSE3, g2o::VertexPlane> {
	public:
		EIGEN_MAKE_ALIGNED_OPERATOR_NEW
			EdgeSE3Plane()
			: BaseBinaryEdge<3, Eigen::Vector3d, g2o::VertexSE3, g2o::VertexPlane>()
		{}
