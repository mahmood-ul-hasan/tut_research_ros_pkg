...
int main (int argc, char** argv)
{
  ...
  do{
    ...
    fit_plane(filterred_data,coefficients,inliers_idxs, outliers_idxs, num_plane, plane_dist_thres);  //fit the plane to the cloud data 
