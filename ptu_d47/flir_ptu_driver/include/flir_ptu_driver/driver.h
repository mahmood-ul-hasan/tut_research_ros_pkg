...
public:
  ...
  */
  ...
  /**
   * sets the desired base (start-up) speed in radians/second
   * \param type 'p' or 't'
   * \param speed drsired base (start-up) speed in radians/sencond
   * \return True if successfully send command
   */
  bool setBaseSpeed(char type, float speed);
  
  /**
   * get the based (start-up) speed in radians/second
   * \param type 'p' or 't'
   * \return Base speed in radians/second
   */
  float getBaseSpeed(char type);
  ...
  */
  ...
  char getSpeedMode();
   ...
   /**
   * Instructs pan-tilt until to immediantely execute position
   * This is default mode
   * \return True if successfully send command
   */
  bool setImmediatePosition();
  
  /**
   * Await the completion of the last issued pan and tilt axis postion
   * \return True if successfully send command
   */
  bool setAwaitPosition();

  bool home();
  
  /**
   * Imemdiately decelerates and halts pan-tilt movement
   * \return True if successfully send command
   */
  bool halt();
