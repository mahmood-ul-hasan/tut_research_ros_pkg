...
namespace g2o {
  G2O_REGISTER_TYPE(EDGE_SE3_GROUND_PLANE, EdgeSE3GroundPlane)
  G2O_REGISTER_TYPE(EDGE_SE3_GROUND_PLANE2, EdgeSE3GroundPlane2)
  G2O_REGISTER_TYPE(EDGE_SE3_GROUND_PLANE3, EdgeSE3GroundPlane3)
  G2O_REGISTER_TYPE(EDGE_SE4_GROUND_PLANE4, EdgeSE3GroundPlane4)
  G2O_REGISTER_TYPE(EDGE_SE3_WALL_PLANE1, EdgeSE3WallPlane1)
  G2O_REGISTER_TYPE(EDGE_SE3_WALL_PLANE2, EdgeSE3WallPlane2)
  G2O_REGISTER_TYPE(EDGE_SE3_WALL_PLANE3, EdgeSE3WallPlane3)
  G2O_REGISTER_TYPE(EDGE_SE3_WALL_PLANE4, EdgeSE3WallPlane4)
  G2O_REGISTER_TYPE(EDGE_SE3_WALL_PLANE5, EdgeSE3WallPlane5)
...
g2o::EdgeSE3* GraphSLAM::add_se3_edge(g2o::VertexSE3* v1, g2o::VertexSE3* v2, const Eigen::Isometry3d& relative_pose, const Eigen::MatrixXd& information_matrix) {
  ...
  //edge->setMeasurementData(relative_distance);
...
g2o::EdgeSE3GroundPlane* GraphSLAM::add_se3_ground_plane_edge(g2o::VertexSE3* v_se3, g2o::VertexPlane* v_plane, const Eigen::Vector4d rms_error, const Eigen::MatrixXd& information_matrix) {
  g2o::EdgeSE3GroundPlane* edge(new g2o::EdgeSE3GroundPlane());
  edge->setMeasurement(rms_error);
  edge->setInformation(information_matrix);
...
g2o::EdgeSE3GroundPlane2* GraphSLAM::add_se3_ground_plane_edge2(g2o::VertexSE3* v_se3, g2o::VertexPlane* v_plane, const Eigen::Vector4d rms_error, const Eigen::MatrixXd& information_matrix) {
  g2o::EdgeSE3GroundPlane2* edge(new g2o::EdgeSE3GroundPlane2());
  edge->setMeasurement(rms_error);
  edge->setInformation(information_matrix);
  edge->vertices()[0] = v_se3;
  edge->vertices()[1] = v_plane;
...
g2o::EdgeSE3GroundPlane3* GraphSLAM::add_se3_ground_plane_edge3(g2o::VertexSE3* v_se3, g2o::VertexPlane* v_plane, const Eigen::Vector4d rms_error, const Eigen::MatrixXd& information_matrix) {
  g2o::EdgeSE3GroundPlane3* edge(new g2o::EdgeSE3GroundPlane3());
  edge->setMeasurement(rms_error);
  edge->setInformation(information_matrix);
  edge->vertices()[0] = v_se3;
  edge->vertices()[1] = v_plane;
...
g2o::EdgeSE3GroundPlane4* GraphSLAM::add_se3_ground_plane_edge4(g2o::VertexSE3* v_se4, g2o::VertexPlane* v_plane, const Eigen::Vector4d rms_error, const Eigen::MatrixXd& information_matrix) {
  g2o::EdgeSE3GroundPlane4* edge(new g2o::EdgeSE3GroundPlane4());
  edge->setMeasurement(rms_error);
  edge->setInformation(information_matrix);
  edge->vertices()[0] = v_se4;
  edge->vertices()[1] = v_plane;
  graph->addEdge(edge);
...
g2o::EdgeSE3WallPlane1* GraphSLAM::add_se3_wall_plane_edge1(g2o::VertexSE3* v_se3, g2o::VertexPlane* v_plane, const Eigen::Vector4d rms_error, const Eigen::MatrixXd& information_matrix) {
  g2o::EdgeSE3WallPlane1* edge(new g2o::EdgeSE3WallPlane1());
  edge->setMeasurement(rms_error);
  edge->setInformation(information_matrix);
  edge->vertices()[0] = v_se3;
  edge->vertices()[1] = v_plane;
...
g2o::EdgeSE3WallPlane2* GraphSLAM::add_se3_wall_plane_edge2(g2o::VertexSE3* v_se3, g2o::VertexPlane* v_plane, const Eigen::Vector4d rms_error, const Eigen::MatrixXd& information_matrix) {
  g2o::EdgeSE3WallPlane2* edge(new g2o::EdgeSE3WallPlane2());
  edge->setMeasurement(rms_error);
  edge->setInformation(information_matrix);
  edge->vertices()[0] = v_se3;
  edge->vertices()[1] = v_plane;
...
g2o::EdgeSE3WallPlane3* GraphSLAM::add_se3_wall_plane_edge3(g2o::VertexSE3* v_se3, g2o::VertexPlane* v_plane, const Eigen::Vector4d rms_error, const Eigen::MatrixXd& information_matrix) {
  g2o::EdgeSE3WallPlane3* edge(new g2o::EdgeSE3WallPlane3());
  edge->setMeasurement(rms_error);
  edge->setInformation(information_matrix);
  edge->vertices()[0] = v_se3;
  edge->vertices()[1] = v_plane;
...
g2o::EdgeSE3WallPlane4* GraphSLAM::add_se3_wall_plane_edge4(g2o::VertexSE3* v_se3, g2o::VertexPlane* v_plane, const Eigen::Vector4d rms_error, const Eigen::MatrixXd& information_matrix) {
  g2o::EdgeSE3WallPlane4* edge(new g2o::EdgeSE3WallPlane4());
  edge->setMeasurement(rms_error);
  edge->setInformation(information_matrix);
  edge->vertices()[0] = v_se3;
  edge->vertices()[1] = v_plane;
...
g2o::EdgeSE3WallPlane5* GraphSLAM::add_se3_wall_plane_edge5(g2o::VertexSE3* v_se3, g2o::VertexPlane* v_plane, const Eigen::Vector4d rms_error, const Eigen::MatrixXd& information_matrix) {
  g2o::EdgeSE3WallPlane5* edge(new g2o::EdgeSE3WallPlane5());
  edge->setMeasurement(rms_error);
  edge->setInformation(information_matrix);
  edge->vertices()[0] = v_se3;
  edge->vertices()[1] = v_plane;
...
int GraphSLAM::optimize(int num_iterations) {
  ...
  graph->setVerbose(true);
   ...
   cerr << "Loaded " << graph->vertices().size() << " vertices" << endl;
  cerr << "Loaded " << graph->edges().size() << " edges" << endl;

   if (!graph->solver()) {
    cerr << "Error allocating solver. Allocating failed!" << endl;
    return 0;
  }
