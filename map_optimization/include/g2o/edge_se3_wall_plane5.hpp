#ifndef KKL_G2O_EDGE_SE3_WALL_PLANE5_HPP
#define KKL_G2O_EDGE_SE3_WALL_PLANE5_HPP
...
namespace g2o {
	class EdgeSE3WallPlane5 : public g2o::BaseBinaryEdge<3, Eigen::Vector4d/*g2o::Plane3D*/, g2o::VertexSE3, g2o::VertexPlane> {
	public:
		...
		void computeError() override {
			...
			Eigen::Isometry3d w2n = v1->estimate();
                        ...
                        rms_err = wall_plane5_rms_error_vertexi(w2n,v1->id());
