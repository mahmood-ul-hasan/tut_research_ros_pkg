...
if __name__ == "__main__":
    ...
    source = o3d.io.read_point_cloud("/media/aisl2/aisl_data/code_ws/pairwise_incremental_registration_using_pcl/build_5_varying_boom_Angle_during_cycle/capture00001.pcd")
    target = o3d.io.read_point_cloud("/media/aisl2/aisl_data/code_ws/pairwise_incremental_registration_using_pcl/build_5_varying_boom_Angle_during_cycle/capture00002.pcd")
    threshold = 2
    # trans_init = np.asarray([[0.862, 0.011, -0.507, 0.5],
    #                          [-0.139, 0.967, -0.215, 0.7],
    #                          [0.487, 0.255, 0.835, -1.4], [0.0, 0.0, 0.0, 1.0]])
    # Set trans_init as the identity matrix
