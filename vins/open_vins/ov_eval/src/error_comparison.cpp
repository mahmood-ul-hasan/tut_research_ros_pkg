...
int main(int argc, char **argv) {
  ...
  // Plot this figure
  matplotlibcpp::figure_size(550, 400);
  ...
  matplotlibcpp::xticks(xticks, labels);
  	// matplotlibcpp::xticks(std::vector<double>(), std::vector<std::string>());  # to remove xtick
 ...
 matplotlibcpp::grid(true);
  ...
  matplotlibcpp::xlim(0.5, ct_pos - 0.5 - 3 * width);
  matplotlibcpp::xticks(xticks, labels);
	// matplotlibcpp::xticks(std::vector<double>(), std::vector<std::string>()); 
 ...
 matplotlibcpp::grid(true);
 matplotlibcpp::save("output_plot.png");
