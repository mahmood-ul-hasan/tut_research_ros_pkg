...
void image_callback(const sensor_msgs::ImageConstPtr &image_msg)
{
    ...
    else if (image_msg->header.stamp.toSec() - last_image_time > 1.2 || image_msg->header.stamp.toSec() < last_image_time)
    {
        std::cout << "image_msg->header.stamp.toSec()  " << image_msg->header.stamp.toSec() << std::endl;
        std::cout << "last_image_time  " << last_image_time << std::endl;
