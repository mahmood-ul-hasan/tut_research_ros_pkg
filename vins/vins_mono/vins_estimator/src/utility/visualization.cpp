...
void pubTF(const Estimator &estimator, const std_msgs::Header &header)
{
    ...
    // ROS_INFO_STREAM("Broadcasting transform from 'world' to 'body' at time " << header.stamp);
    // ROS_INFO_STREAM("Transform origin: " << transform.getOrigin().x() << ", " << transform.getOrigin().y() << ", " << transform.getOrigin().z());
    // ROS_INFO_STREAM("Transform rotation: " << transform.getRotation().x() << ", " << transform.getRotation().y() << ", " << transform.getRotation().z() << ", " << transform.getRotation().w());
    ...
    transform.setRotation(q);
    // ROS_INFO_STREAM("Broadcasting transform from 'body' to 'camera' at time " << header.stamp);
    // ROS_INFO_STREAM("Transform origin: " << transform.getOrigin().x() << ", " << transform.getOrigin().y() << ", " << transform.getOrigin().z());
    // ROS_INFO_STREAM("Transform rotation: " << transform.getRotation().x() << ", " << transform.getRotation().y() << ", " << transform.getRotation().z() << ", " << transform.getRotation().w());
