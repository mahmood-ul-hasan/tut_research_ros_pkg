...
class path_pub():
    def __init__(self):
        ...
        self.gt_path_pub = rospy.Publisher("/odom_crane_structural_info_path", Path, queue_size=2)
        self.gt_poses = rospy.Subscriber('/odom_crane_structural_info', Odometry, self.gtcallback)
