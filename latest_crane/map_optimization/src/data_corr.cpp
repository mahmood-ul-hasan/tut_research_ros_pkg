...

{
 ...
 // Retrieve the file_directory parameter from the ROS parameter server
  ...
  std::string pcd_file = build_folder + pcd_file_name;
...
pcd_file = build_folder + "wall_seg1.pcd";
...
if (number_of_wall_planes >= 2) {
  ...
  pcd_file = build_folder + "wall_seg2.pcd";
...
if (number_of_wall_planes >= 3) {
  ...
  pcd_file = build_folder + "wall_seg3.pcd";
...
if (number_of_wall_planes >= 4) {
  ...
  pcd_file = build_folder + "wall_seg4.pcd";
...
if (number_of_wall_planes >= 5) {
  ...
  pcd_file = build_folder +  "wall_seg5.pcd";
  ...
  std::cout << " coeffs_ground1 " << coeffs_ground1 << std::endl;

  pcd_file = build_folder + "ground_seg1.pcd";
...
if (number_of_ground_planes >= 2) {
    ...
    pcd_file = build_folder + "ground_seg2.pcd";
...
if (number_of_ground_planes >= 3) {
    ...
    pcd_file = build_folder + "ground_seg3.pcd";
...
if (number_of_ground_planes >= 4) {
    ...
    pcd_file = build_folder + "ground_seg4.pcd";
...
if (number_of_ground_planes >= 5) {
    ...
    pcd_file = build_folder + "ground_seg5.pcd";
...
// pcl::visualization::PointCloudColorHandlerCustom<PointT> single_color_red(plane_cloud_ground1, 255, 0, 0); // Green color
// viewer_optimization.addPointCloud<PointT>(plane_cloud_ground1, single_color_red, "plane_cloud_ground1", sub_window_1);
// viewer_optimization.addPointCloud<PointT>(plane_cloud_ground1, single_color_red, "plane_cloud_ground11", sub_window_2);
// viewer_optimization.addPointCloud<PointT>(plane_cloud_ground1, single_color_red, "plane_cloud_ground111", sub_window_3);
...
std::cout << " index plot 2 " << std::endl;
...
std::cout << " index plot 3 " << std::endl;
  ...
  if(markers_pub.getNumSubscribers()) {
   ...
   std::cout << x[0] << std::endl;
    std::cout << "display Pose after optimizatio" <<  std::endl;
    plt::figure();
