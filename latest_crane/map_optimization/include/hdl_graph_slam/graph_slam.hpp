...
namespace g2o {
  ...
  class EdgeSE3;
  class EdgeSE3GroundPlane;
  class EdgeSE3GroundPlane2;
  class EdgeSE3GroundPlane3;
  class EdgeSE3GroundPlane4;
  class EdgeSE3WallPlane1;
  class EdgeSE3WallPlane2;
  class EdgeSE3WallPlane3;
  class EdgeSE3WallPlane4;
  class EdgeSE3WallPlane5;
...
public:
   ...
   * @param v_plane  ground_plane node
   * @param plane_coeffs  plane coefficients w.r.t. v_se3
   * @param information_matrix  information matrix (it must be 3x3)
   * @return registered edge
   */
  g2o::EdgeSE3GroundPlane* add_se3_ground_plane_edge(g2o::VertexSE3* v_se3, g2o::VertexPlane* v_plane, Eigen::Vector4d rms_error, const Eigen::MatrixXd& information_matrix);
...
/**
   ...
   * @return registered edge
   */
  g2o::EdgeSE3GroundPlane2* add_se3_ground_plane_edge2(g2o::VertexSE3* v_se3, g2o::VertexPlane* v_plane, Eigen::Vector4d rms_error, const Eigen::MatrixXd& information_matrix);
...
/**
   ...
   * @return registered edge
   */
  g2o::EdgeSE3GroundPlane3* add_se3_ground_plane_edge3(g2o::VertexSE3* v_se3, g2o::VertexPlane* v_plane, Eigen::Vector4d rms_error, const Eigen::MatrixXd& information_matrix);
...
/**
   ...
   * @return registered edge
   */
  g2o::EdgeSE3GroundPlane4* add_se3_ground_plane_edge4(g2o::VertexSE3* v_se3, g2o::VertexPlane* v_plane, Eigen::Vector4d rms_error, const Eigen::MatrixXd& information_matrix);


  /**
   * @brief add an edge between an SE3 node and a plane node
   * @param v_se3    SE3 node
   * @param v_plane  wall_plane node1
   * @param plane_coeffs  plane coefficients w.r.t. v_se3
   * @param information_matrix  information matrix (it must be 3x3)
   * @return registered edge
   */
  g2o::EdgeSE3WallPlane1* add_se3_wall_plane_edge1(g2o::VertexSE3* v_se3, g2o::VertexPlane* v_plane, Eigen::Vector4d rms_error, const Eigen::MatrixXd& information_matrix);
   ...
   * @return registered edge
   */
  g2o::EdgeSE3WallPlane2* add_se3_wall_plane_edge2(g2o::VertexSE3* v_se3, g2o::VertexPlane* v_plane, Eigen::Vector4d rms_error, const Eigen::MatrixXd& information_matrix);
   ...
   * @return registered edge
   */
  g2o::EdgeSE3WallPlane3* add_se3_wall_plane_edge3(g2o::VertexSE3* v_se3, g2o::VertexPlane* v_plane, Eigen::Vector4d rms_error, const Eigen::MatrixXd& information_matrix);
   ...
   * @return registered edge
   */
  g2o::EdgeSE3WallPlane4* add_se3_wall_plane_edge4(g2o::VertexSE3* v_se3, g2o::VertexPlane* v_plane, Eigen::Vector4d rms_error, const Eigen::MatrixXd& information_matrix);
   ...
   * @return registered edge
   */
  g2o::EdgeSE3WallPlane5* add_se3_wall_plane_edge5(g2o::VertexSE3* v_se3, g2o::VertexPlane* v_plane, Eigen::Vector4d rms_error, const Eigen::MatrixXd& information_matrix);
