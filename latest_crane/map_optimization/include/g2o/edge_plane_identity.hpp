...
#include <g2o/types/slam3d_addons/vertex_plane.h>
 ...
 std::vector<double> g2o_error_plane_identity_a;
 std::vector<double> g2o_error_plane_identity_b;
 std::vector<double> g2o_error_plane_identity_c;
 std::vector<double> g2o_error_plane_identity_d;
...
public:
  ...
  void computeError() {
    ...
    g2o_error_plane_identity_a.push_back(_error[0]);
    g2o_error_plane_identity_b.push_back(_error[1]);
    g2o_error_plane_identity_c.push_back(_error[2]);
    g2o_error_plane_identity_d.push_back(_error[3]);
