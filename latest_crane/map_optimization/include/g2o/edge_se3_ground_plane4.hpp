#ifndef KKL_G2O_EDGE_SE3_GROUND_PLANE4_HPP
#define KKL_G2O_EDGE_SE3_GROUND_PLANE4_HPP
...
namespace g2o {
	class EdgeSE3GroundPlane4 : public g2o::BaseBinaryEdge<3, Eigen::Vector4d/*g2o::Plane3D*/, g2o::VertexSE3, g2o::VertexPlane> {
	public:
		...
		void computeError() override {
			...
			Eigen::Isometry3d w2n = v1->estimate();
                        ...
                        rms_err = ground_plane4_rms_error_vertexi(w2n,v1->id());
