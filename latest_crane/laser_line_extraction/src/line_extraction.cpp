...
// void LineExtraction::mergeLinesSameLine()
// {
//   std::vector<Line> merged_lines;
...
//     Eigen::Vector2d p1_start(lines_[i-1].getStart()[0], lines_[i-1].getStart()[1]);
//     Eigen::Vector2d p1_end(lines_[i-1].getEnd()[0], lines_[i-1].getEnd()[1]);
//     Eigen::Vector2d p2_start(lines_[i].getStart()[0], lines_[i].getStart()[1]);
//     Eigen::Vector2d p2_end(lines_[i].getEnd()[0], lines_[i].getEnd()[1]);
...
//     bool same_line = std::abs(cos_angle) > std::cos(10 * M_PI / 180); // 5 degrees tolerance
...
//       std::cout << "merged lines are start1: (" << lines_[i-1].getStart()[0] << ", " << lines_[i-1].getStart()[1]
//           << ") end1: (" << lines_[i-1].getEnd()[0] << ", " << lines_[i-1].getEnd()[1]
//           << ") start2: (" << lines_[i].getStart()[0] << ", " << lines_[i].getStart()[1]
//           << ") end2: (" << lines_[i].getEnd()[0] << ", " << lines_[i].getEnd()[1] << ") ================================================" << std::endl;
...
//       cov[3] = P_m(1,1);
//       std::vector<unsigned int> indices;
//       indices.reserve(lines_[i-1].getIndices().size() + lines_[i].getIndices().size());
//       indices.insert(indices.end(), lines_[i-1].getIndices().begin(), lines_[i-1].getIndices().end());
//       indices.insert(indices.end(), lines_[i].getIndices().begin(), lines_[i].getIndices().end());
...
//       std::cout << "NOT merged lines are start1: (" << lines_[i-1].getStart()[0] << ", " << lines_[i-1].getStart()[1]
//           << ") end1: (" << lines_[i-1].getEnd()[0] << ", " << lines_[i-1].getEnd()[1]
//           << ") start2: (" << lines_[i].getStart()[0] << ", " << lines_[i].getStart()[1]
//           << ") end2: (" << lines_[i].getEnd()[0] << ", " << lines_[i].getEnd()[1] << ")" << std::endl;
...
//   // Update the lines with merged or unmerged segments
//   lines_ = merged_lines;
// }
