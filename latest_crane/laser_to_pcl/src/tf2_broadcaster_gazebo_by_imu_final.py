...
boom_link_default_joint = math.pi / 2
...
def imu_boom_link_callback(msg):
    ...
    print(" imu_boom_link_callback ", j, (euler_boom[1] - boom_link_default_joint) * 180 / math.pi)
...
def imu_hook_link_callback(msg):
    ...
    noise = np.random.uniform(-0.0174533, 0.0174533)
    # noise = 0
    #print("noiose", noise*180/math.pi)
...
if __name__ == '__main__':
    ...
    # rospy.Subscriber("/imu0", Imu, imu_boom_link_callback)
    # rospy.Subscriber("/imu0", Imu, imu_upper_link_callback)
