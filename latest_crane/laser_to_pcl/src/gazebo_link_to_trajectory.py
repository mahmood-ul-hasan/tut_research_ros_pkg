...
class path_pub():
    def __init__(self):
        ...
        self.gt_poses = rospy.Subscriber('/gazebo/link_states', LinkStates,  self.gtcallback)
        self.gt_pose_pub = rospy.Publisher('gt_path_pose', PoseStamped, queue_size=10)
    ...
    def gtcallback(self, msg):
        ...
        #         self.check= 1
            ...
            # Identify the link you want to track
        desired_link_name = 'k_crane::front_laser_link'

        # Extract position and orientation information for the selected link
        link_pose = None
    ...
    while 1:
        try:
            if path_pub_class.check == 1:
                ...
                path_pub_class.gt_pose_pub.publish(pose)
