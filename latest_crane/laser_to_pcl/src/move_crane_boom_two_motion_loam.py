...
if __name__ == '__main__':
    ...
    pitch_start_point_increment = 1
    yaw_start_point_increment = pitch_start_point_increment 
    ...
    while not rospy.is_shutdown():
        ...
        if (pitch_start_point <= -50 + 2*pitch_start_point_increment):
