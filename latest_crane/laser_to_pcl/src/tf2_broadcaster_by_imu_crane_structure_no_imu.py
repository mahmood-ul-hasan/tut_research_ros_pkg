...
def rotating_base_link_callback(msg):
    ...
    t.transform.translation.x = -7.234
   ...
   # print("Pos-90= ",ii , msg.position[0]-90)
    ...
    static_transform_publisher("lower_link", "upper_link", 0.0 , 0.0, 0.0,   0, 0, 0)
    static_transform_publisher("upper_link", "boom_link", 0.0 , 0.0, 0.33,   0, 0, 0)
