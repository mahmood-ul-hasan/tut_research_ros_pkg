...
def imu_upper_link_callback(msg):
    ...
    # noise = np.random.uniform(-0.0174533*2, 0.0174533*2)
    noise = 0
    #print ("yaw noise", noise*180/math.pi)

    # quat_upper_yaw = quaternion_from_euler(0, 0, euler_upper[2])
    quat_upper_yaw = quaternion_from_euler(0, 0, euler_upper[2] + noise / 4)
    ...
    # print ("imu_upper_link_callback", euler_upper[2]*180/math.pi)
...
def imu_boom_link_callback(msg):
    ...
    quat_boom_yaw = quaternion_from_euler(0, euler_boom[1] - boom_link_default_joint + noise / 6, 0,)
    ...
    # print(" imu_boom_link_callback ",  (euler_boom[1] -boom_link_default_joint)*180/math.pi, j)
    # print(" imu_boom_link_callback ",  (euler_boom[1] -boom_link_default_joint)*180/math.pi, j)
    ...
    # static_transform_publisher("boom_link", "laser", 0,0,0, 90*math.pi/180, 0, 0)
    static_transform_publisher("boom_link", "front_laser_link", 14.392, 0, 0, 90 * math.pi / 180, 0, 0 * math.pi / 180)
