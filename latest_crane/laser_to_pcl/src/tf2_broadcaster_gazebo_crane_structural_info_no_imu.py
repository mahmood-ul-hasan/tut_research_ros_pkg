...
def imu_boom_link_callback(msg):
    ...
    global pervious_time_boom_link, noise
    ...
    # broadcast the tf by rpy of imu
    # quat_boom_yaw = quaternion_from_euler(0, euler_boom[1] - boom_link_default_joint + noise*1.2 , 0,)
    ...
    print("u upper_link ", euler_boom[2] * 180 / math.pi, "boom_link ", (euler_boom[1] - boom_link_default_joint) * 180 / math.pi)
...
def imu_hook_link_callback(msg):
    ...
    static_transform_publisher("lower_link", "upper_link", 0, 0, 0,   0, 0, 0)
    static_transform_publisher("upper_link", "boom_link", 1.5, 0, 1,   0, 0, 0)
    static_transform_publisher("boom_link", "imu_link", 0.5, 0, 0,   0, 90*math.pi/180, 0)
