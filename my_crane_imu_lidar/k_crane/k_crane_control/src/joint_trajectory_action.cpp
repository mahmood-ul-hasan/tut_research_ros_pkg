...
control_msgs::FollowJointTrajectoryGoal Crane::crane_extension_trajectory(sensor_msgs::JointState joint_state){
	// Read CSV file
	CSV::CsvFile angle_data("/home/harumo/catkin_ws/src/k_crane/data/IMU_experiment/input_data/angle.csv");
	...
	for (int i = 0; i < angle_data.collumn_size(); i++) {
		...
		goal.trajectory.points[i].positions[0] = 45 * M_PI/180;						// pitch joint
