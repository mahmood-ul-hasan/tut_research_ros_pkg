...
int main(int argc, char** argv)
{
  ...
  // odomBefMapped.header.frame_id = "camera_init";
  ...
  aftMappedTrans.frame_id_ = "camera_init_2";
  aftMappedTrans.child_frame_id_ = "camera_init";
  ...
  while (status) {
    ...
    if (newLaserCloudLast && newLaserOdometry && fabs(timeLaserCloudLast - timeLaserOdometry) < 0.005) {
      ...
      *laserCloudLast = *laserCloudCorner2 + *laserCloudSurf2;
      ...
      if (laserCloudSurfFromMap->points.size() > 500  && laserCloudCornerFromMap->points.size() > 500)
      {
      ...
      // laserCloudSurround2.header.frame_id = "camera_init";
      ...
      current_time = timeLaserOdometry;
