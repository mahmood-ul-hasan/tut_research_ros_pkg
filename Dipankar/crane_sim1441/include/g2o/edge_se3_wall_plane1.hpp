#ifndef KKL_G2O_EDGE_SE3_WALL_PLANE1_HPP
#define KKL_G2O_EDGE_SE3_WALL_PLANE1_HPP
...
namespace g2o {
	class EdgeSE3WallPlane1 : public g2o::BaseBinaryEdge<3, Eigen::Vector4d/*g2o::Plane3D*/, g2o::VertexSE3, g2o::VertexPlane> {
	public:
		...
		void computeError() override {
			...
			Eigen::Isometry3d w2n = v1->estimate();
                        ...
                        rss_err = wall_plane1_rss_error_vertexi(w2n,v1->id());
