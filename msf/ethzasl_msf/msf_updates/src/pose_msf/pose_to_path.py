...
class path_pub():
    def __init__(self):
        ...
        self.gt_path_pub = rospy.Publisher("/msf_core/path", Path, queue_size=2)
        # self.gt_poses = rospy.Subscriber("/gazebo/model_states", ModelStates, self.gtcallback)
        self.gt_poses = rospy.Subscriber('/msf_core/pose', PoseWithCovarianceStamped, self.gtcallback)
