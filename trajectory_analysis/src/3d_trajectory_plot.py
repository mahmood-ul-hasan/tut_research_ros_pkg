...
# List of file paths
path = '/home/aisl2/catkin_ws/src/data/model_crane_data/23_9_21_model_crane_data_to_compare_different_methods/'
...
file_paths = [
    ...
    path + file_common_name + '/camera_structural_info/trj_01/camera_structural_info.txt',
    path + file_common_name + '/vins_mono/trj_01/vins_mono.txt',
...
labels = ['ground_truth', 'camera_structural_info', 'vins', 'neural_network', 'vins_fusion_stereo+EKF', 'vins_mono', 'vins_mono+EKF']
