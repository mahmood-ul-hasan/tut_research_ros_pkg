...
def odom_callback(odom, listener):
    ...
    try:
        ...
        roll = original_rpy[1] 
        pitch = - original_rpy[0]
        yaw = original_rpy[2]     + 97 * math.pi / 180
        ...
        new_odom_msg.pose.pose.orientation.x =  transformed_pose.pose.orientation.x
        new_odom_msg.pose.pose.orientation.y =  transformed_pose.pose.orientation.y
        new_odom_msg.pose.pose.orientation.z =  transformed_pose.pose.orientation.z
        new_odom_msg.pose.pose.orientation.w =  transformed_pose.pose.orientation.w
...
if __name__ == '__main__':
    rospy.init_node('gt_odom_republisher_in_world_frame_quat')
    ...
    odom_rpy_pub = rospy.Publisher('/camera/odom/sample_rpy__', Odometry, queue_size=10)
