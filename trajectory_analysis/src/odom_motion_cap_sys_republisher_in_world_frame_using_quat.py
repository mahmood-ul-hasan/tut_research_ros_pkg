...
def odom_callback(odom, listener):
    ...
    try:
        ...
        roll = original_rpy[0] -  90 * math.pi / 180
        # pitch = original_rpy[1] + 4 * math.pi / 180
        pitch = original_rpy[1] + 7 * math.pi / 180
        yaw = original_rpy[2]    
...
if __name__ == '__main__':
    ...
    odom_rpy_pub = rospy.Publisher('/odom_motion_cap_sys_world_frame_rpy__', Odometry, queue_size=10)
