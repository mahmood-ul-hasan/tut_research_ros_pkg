...
path = '/media/aisl2/aisl_data/catkin_ws/src/data/model_crane_data/23_9_21_model_crane_data_to_compare_different_methods/'
camera_structural_info_plot = "camera_structural_info/trj_01/"
...
camera_structural_info_file_address = os.path.join(path, file_common_name, camera_structural_info_plot, "camera_structural_info.txt")
vins_mono_file_address = os.path.join(path, file_common_name, vins_mono_plot, "vins_mono.txt")
...
command1 = "rosrun ov_eval error_dataset posyaw {} {}".format(truth_file_address, folder_address)
command2 = "rosrun ov_eval error_comparison posyaw {} {}".format(truth_folder_address, folder_address)
command3 = "rosrun ov_eval plot_trajectories posyaw {} {} {}".format(truth_file_address, camera_structural_info_file_address, vins_mono_file_address)
# command3 = "rosrun ov_eval plot_trajectories posyaw {} {}".format(truth_file_address,  vins_mono_file_address)


# command3 = " rosrun ov_eval plot_trajectories posyaw  /home/aisl2/catkin_ws/src/data/model_crane_data/23_9_21_model_crane_data_to_compare_different_methods/random_1/camera_structural_info/trj_01/camera_structural_info.txt     /home/aisl2/catkin_ws/src/data/model_crane_data/23_9_21_model_crane_data_to_compare_different_methods/truth/random_1/trj_01.txt "
print(command3)
...
print(" ")
print("camera_structural_info_file_address", camera_structural_info_file_address)
print(" ")
# print(command1)
print(" ")
